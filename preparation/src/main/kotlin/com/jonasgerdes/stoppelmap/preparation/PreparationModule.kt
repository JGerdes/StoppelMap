...
val preparationModule = module {
    ...
    single {
        ...
        Settings(
            ...
            crawledBusRoutesDirectory = File(resources, "routes").also { if (it.exists().not()) it.mkdirs() },
            crawledTrainRoutesDirectory = File(resources, "routes-train").also { if (it.exists().not()) it.mkdirs() },
