...
public class SilhouettePreview extends WidgetPreview
    ...
    private Font mFont = Font.RobotoSlab;
    ...
    public void update() {
        ...
        Bitmap countdownBitmap = SilhouetteWidgetProvider.
                createCountdownBitmap(
                getContext(),
    ...
    public void saveSettings(WidgetSettingsHelper settingsHelper) {
        ...
        settingsHelper.putString(SilhouetteWidgetProvider.SETTING_FONT, mFont.getFileName());
