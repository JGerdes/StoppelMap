...
public class InitialTransaction implements Realm.Transaction {
    ...
    public static AdvancedTag[] TAG_SYNONYMS = new AdvancedTag[]{
            ...
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Pilze"),
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Fisch"),
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Spieße"),
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Blumenkohl"),
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Reibekuchen"),
            new AdvancedTag(R.drawable.ic_local_dining_black_24dp, "Flammkuchen"),
