...
data class TypeSearchResultItem(
    val result: SearchResult.TypeSearchResult
) : Item() {
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.apply {
            ...
            icon.setDrawableFromTypeOrHide(result.type.slug)

        }
    }

    override fun isSameAs(other: com.xwray.groupie.Item<*>?): Boolean {
        if (other !is TypeSearchResultItem) {
            return false
        }
